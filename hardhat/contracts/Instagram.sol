...
contract Instagram {
    ...
    function getPost(
        uint256 _postId
    ) public view postsExists(_postId) returns (Post memory) {
    ...
    function getLikesOfPost(
        uint256 _postId
    ) public view postsExists(_postId) returns (uint256) {
    ...
    function getUri(
        uint256 _postId
    ) public view postsExists(_postId) returns (string memory) {
